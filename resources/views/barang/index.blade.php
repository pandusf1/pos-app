...
<style>
    ...
    .table td {
        ...
        white-space: nowrap; /* cegah kolom melebar */
    }
...
<div class="glass-card">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('barang.create') }}" class="btn btn-navy">
            + Tambah Barang
        </a>
    </div>
    ...
    <table class="table align-middle">
        ...
        @forelse($barangs as $b)
            <tr>
                <td class="kode">{{ $b->kd_brg }}</td>
                <td class="nm_brg">{{ $b->nm_brg }}</td>
                <td class="fw-semibold">{{ $b->satuan }}</td>
